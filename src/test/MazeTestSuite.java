 ...
 */
public class MazeTestSuite {
    /**
     * Singleton instance of this class.
     * Constructed and accessed through getInstance().
     */
    private static MazeTestSuite instance = null;
     ...
     */
    public static MazeTestSuite getInstance() {
        if (instance == null) instance = new MazeTestSuite();
        return instance;
    }
    ...
    private static List<TestCase> generateTestCases() {
        ...
        testCases.add(new TestCase("SolveSmallMaze", MazeTestMethods::solveSmallMaze));
        testCases.add(new TestCase("SolveNoSolutionMaze", MazeTestMethods::solveNoSolutionMaze));
        testCases.add(new TestCase("SolveTwoSolutionMaze", MazeTestMethods::solveTwoSolutionMaze));
